                ...
                <div className="rounded-3xl border border-tertiary/40 bg-white/90 p-6 shadow-[0_24px_70px_-40px_rgba(120,53,15,0.6)] sm:p-8">
                    ...
                    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
                                ...
                                <div key={field.name} data-invite-reveal className="flex flex-col gap-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`min-h-12 w-full rounded-xl border bg-white/80 pl-10 text-base text-[#5b4a3a] outline-none transition-colors focus:border-primary md:text-lg ${isPassword ? 'pr-11' : 'pr-3'
                        ...
                        {schema.map((field) => {
                            ...
                            const commonClasses = `w-full rounded-xl border bg-white/80 px-3 text-base text-[#5b4a3a] outline-none transition-colors focus:border-primary md:text-lg ${hasError ? 'border-red-500' : 'border-tertiary/50'
                                }`
